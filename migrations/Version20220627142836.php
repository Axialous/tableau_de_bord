 ...
 */
final class Version20220627142836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categories ADD parent_id INT DEFAULT NULL, ADD name VARCHAR(100) NOT NULL, DROP nom');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categories ADD nom VARCHAR(255) NOT NULL, DROP parent_id, DROP name');
    }
}
